...
export default class FresnelMaterial extends THREE.ShaderMaterial {
  constructor(options) {
    super();
    ...
    this.fragmentShader = `
      ...
      void main() {
        ...
        fresnelTerm = clamp(pow(fresnelTerm, 2.5), 0.0, 1.0);
        vec4 worldColor = vec4(color/255.0 + fresnelTerm * 0.1, 1.0);
        gl_FragColor = worldColor;

        // gl_FragColor.rgb = vec3(dotN);
